...
if(empty($pref)){
echo "<span class='w3-text-red w3-bold w3-animate-zoom'>Preference should not be empty</span><br>";
exit();
}elseif (!preg_match("/^[a-zA-Z ]*$/",$pref)) {
echo "<span class='w3-text-red w3-bold w3-animate-zoom'>Preference should only contain letters and whitespaces</span><br>";
exit();
}else{
...
<div class="w3-panel w3-padding-large w3-center w3-card-4 w3-light-grey w3-round-large"style="width:90%;margin:auto;">
 ...
 <p id="sampletxt"style="font-family:cursive;padding:0;margin:25px;">Brown skin girl :) , lets play a game of Love and Romance</p>
