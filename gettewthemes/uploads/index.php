...
<body class="w3-light-grey"style="margin:0;font-family: cursive;">
  ...
  <img src="social.jpg" class="w3-image"style="width:100%;max-height:400px;">
      ...
      <a href="oaumeetupfindmatch.php"><div class="w3-container "style="max-width:700px;margin-left:auto;margin-right:auto;margin-top:5px;">
      	...
      	<a href="oaumeetupshowachats.php"><div class="w3-blue w3-center w3-animate-zoom w3-card w3-ripple w3-round-large">
      	...
      	<a href="oaumeetupshowfchats.php"><div class="w3-blue w3-center w3-animate-zoom w3-card w3-ripple w3-round-large">
