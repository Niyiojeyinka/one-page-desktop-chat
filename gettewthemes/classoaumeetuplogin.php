...
class meetuplogin extends meetupvalidate{
    ...
    $sql = "select userid,username,password,meetup_preference,attributes from oaumeetupusers where email = '$email'and password='$pass' and activated ='1' limit 1";
    $result = $conn->query($sql);
    if ($result->num_rows > 0) {
    $userid=$dbuname=$dbpass=$a="";
